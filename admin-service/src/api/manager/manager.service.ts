import {Injectable,Logger,HttpException,HttpStatus, UnauthorizedException,Inject, OnModuleInit,
} from '@nestjs/common';
...
import {ManagerServiceGrpc,GetSignUpRequest,GetSignUpResponse ,ManagerData}  from './interface/interface'
