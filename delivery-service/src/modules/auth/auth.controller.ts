...
export class AuthController {
  ...
  async handleRegisterEmail(@Body() registerEmailData: RegisterEmailDto) {
    /** 
     * Handles the initial email registration for a delivery partner.
     * 
     * Args:
     *   registerEmailData (RegisterEmailDto): The data transfer object containing the email for registration.
     * 
     * Returns:
     *   Promise<any>: The result of the email registration process.
     */
    const { email } = registerEmailData;
    return await this.authService.handleRegisterEmail(email);
  }
  ...
  async register(@CurrentPartner('sub') partnerEmail: string, @Body() createDeliveryPartnerData: RegisterPartnerDto) {
    /**
     * Registers a new delivery partner after OTP verification.
     * 
     * Args:
     *   partnerEmail (string): The email of the partner, extracted from the current partner context.
     *   createDeliveryPartnerData (RegisterPartnerDto): The data transfer object containing partner registration details.
     * 
     * Returns:
     *   Promise<any>: The result of the registration process.
     */
    this.logger.info('Registering new delivery partner', {
      service: 'AuthController',
      method: 'register',
  ...
  async login(@Body() credentials: LoginPartnerDto) {
    /**
     * Authenticates a delivery partner and logs them in.
     * 
     * Args:
     *   credentials (LoginPartnerDto): The data transfer object containing login credentials (email and password).
     * 
     * Returns:
     *   Promise<any>: The result of the login process, typically including authentication tokens.
     */
    this.logger.info('Login attempt', {
      service: 'AuthController',
      method: 'login',
  ...
  async changePassword(
    ...
    /**
     * Changes the password for an authenticated delivery partner.
     * 
     * Args:
     *   partnerId (Types.ObjectId): The unique identifier of the authenticated partner.
     *   changePasswordData (ChangePasswordDto): The data transfer object containing the old and new passwords.
     * 
     * Returns:
     *   Promise<any>: The result of the password change process.
     */
    this.logger.info('Password change requested', {
      service: 'AuthController',
      method: 'changePassword',
  ...
  async forgotPassword(@Body() forgotPasswordData: ForgotPasswordDto) {
     ...
     * 
     * Returns:
     *   Promise<any>: The result of the forgot password process.
     */
    this.logger.info('Forgot password initiated', {
      service: 'AuthController',
      method: 'forgotPassword',
  ...
  async resendOtp(@CurrentPartner() partnerEmail: string) {
    /**
     * Resends an OTP for password reset to the partner's email.
     * 
     * Args:
     *   partnerEmail (string): The email of the partner requesting the OTP.
     * 
     * Returns:
     *   Promise<{ success: boolean, message: string }>: A success response with a confirmation message.
     */
  ...
  async verifyOtp(@CurrentPartner() partnerEmail: string, @Body('otp') otp: string) {
    /**
     * Verifies the OTP provided by the partner for password reset.
     * 
     * Args:
     *   partnerEmail (string): The email of the partner verifying the OTP.
  ...
  async updatePassword(
    ...
    /**
     * Updates the password for a partner after OTP verification.
     * 
     * Args:
     *   partnerEmail (string): The email of the partner updating their password.
     *   updatePasswordData (UpdatePasswordDto): The data transfer object containing the new password.
     * 
     * Returns:
     *   Promise<any>: The result of the password update process.
     */
    this.logger.info('Password update initiated', {
      service: 'AuthController',
      method: 'updatePassword',
