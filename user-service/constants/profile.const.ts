...
export const WINSTON_LOGGER_PROFILE = {
  ...
  PROFILE_FOUND: 'Profile found for id',
  UPDATE_PROFILE: 'Updating profile with id',

  PROFILE_UPDATE_FAILED: 'Profile update failed for id',
  PROFILE_UPDATE_SUCCESS: 'Profile updated Successfully',
  PROFILE_SOFT_DELETE: 'Soft deleting profile with id',
};
